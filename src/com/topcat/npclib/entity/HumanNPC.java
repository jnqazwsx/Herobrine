...
public class HumanNPC extends NPC {
        ...
        private net.minecraft.server.v1_4_5.ItemStack[] previousEquipment = { null, null, null, null, null };
	...
	public void updateEquipment() {
                ...
                for (int i = 0; i < previousEquipment.length; i++) {
                        ...
                        net.minecraft.server.v1_4_5.ItemStack current = ((EntityPlayer)getEntity()).getEquipment(i);
                        if (current == null) { 
                                continue; 
                        }
                        if (!net.minecraft.server.v1_4_5.ItemStack.equals(previous, current) || (previous != null && !previous.equals(current))) {
