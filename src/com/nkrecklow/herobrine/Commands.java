            ...
            if (sender instanceof Player) {
                ...
                if (args[0].equalsIgnoreCase("appear")) {
                    if (args.length == 2) {
                        ...
                        Main.getInstance().getActionManager().runAction(Action.ActionType.APPEAR, target, player, false);
                    } else {
                    ...
                    if (args.length == 2) {
                        ...
                        Main.getInstance().getActionManager().runAction(Action.ActionType.BURY_PLAYER, target, player, false);
                    } else {
                    ...
                    if (args.length == 2) {
                        ...
                        Main.getInstance().getActionManager().runAction(Action.ActionType.PLACE_SIGN, target, player, false);
                    } else {
                    ...
                    if (args.length == 2) {
                        ...
                        Main.getInstance().getActionManager().runAction(Action.ActionType.PLAY_SOUND, target, player, false);
                    } else {
                    ...
                    if (args.length == 2) {
                        ...
                        Main.getInstance().getActionManager().runAction(Action.ActionType.PLACE_TORCH, target, player, false);
                    } else {
                    ...
                    if (args.length == 1) {
                        if (Main.getInstance().getMobController().isSpawned()) {
                            player.teleport(Main.getInstance().getMobController().getMob().getEntity().getLocation());
                            player.sendMessage(Util.formatString("Teleported to Herobrine."));
                            Main.getInstance().logEvent("Teleported " + player.getName() + " to Herobrine.");
                        } else {
                            player.sendMessage(Util.formatString("Herobrine currently isn't alive."));
                        }
                    } else {
                    ...
                    if (args.length == 2) {
                        ...
                        Main.getInstance().getActionManager().runAction(Action.ActionType.ENTER_NIGHTMARE, target, player, false);
                    } else {
                    ...
                    if (args.length == 2) {
                        ...
                        Main.getInstance().getActionManager().runAction(Action.ActionType.CREATE_TNT_TRAP, target, player, false);
                    } else {
                    ...
                    if (args.length == 2) {
                        ...
                        Main.getInstance().getActionManager().runAction(Action.ActionType.CREATE_PYRAMID, target, player, false);
                    } else {
                    ...
                    if (args.length == 2) {
                        ...
                        Main.getInstance().getActionManager().runAction(Action.ActionType.SUFFOCATE_PLAYER, target, player, false);
                    } else {
                        player.sendMessage(Util.formatString("Not a valid command! Type \"/hb suffocate username\"."));
                    }
                } else if (args[0].equalsIgnoreCase("possess")) {
                    if (args.length == 2) {
                        Player target = Main.getInstance().getServer().getPlayer(args[1]);
                        if (target == null) {
                            player.sendMessage(Util.formatString("I can't seem to find that player."));
                        ...
                        Main.getInstance().getActionManager().runAction(Action.ActionType.POSSESS_PLAYER, target, player, false);
                    } else {
                        player.sendMessage(Util.formatString("Not a valid command! Type \"/hb possess username\"."));
                    }
                } else if (args[0].equalsIgnoreCase("reload")) {
                    Main.getInstance().getConfiguration().loadConfig();
                    player.sendMessage(Util.formatString("Reloaded configuration file!"));
                    Main.getInstance().log("Reloaded configuration file!");
                ...
                Main.getInstance().log("You must be a player to use this command.");
            }
        } else {
            if (sender instanceof Player) {
                Player player = (Player) sender;
